  ...
  <div class="card-body mt-3">
    ...
    <div class="form-group">
      ...
      <div class="form-check">
        <input class="form-check-input" id="baru" name="kondisi" type="radio" value="Baru"
          @checked(isset($data) && $data->kondisi === 'Baru') required>
        <label class="form-check-label" for="baru">Baru</label>
      </div>
      <div class="form-check">
        <input class="form-check-input" id="bekas" name="kondisi" type="radio" value="Bekas"
          @checked(isset($data) && $data->kondisi === 'Bekas') required>
